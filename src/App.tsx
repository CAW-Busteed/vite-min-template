...
import { Flex, Stack, Button, Container, MantineProvider, Title } from "@mantine/core";
import { theme } from "./theme";
import PostComp from "./Components/PostComp";
import HistorySm from "./Components/HistorySm";
    ...
    <Container>
      <Container bg='cyan' pl={0} style={{ width: '65%', display: 'flex', alignItems: 'center', position: 'absolute', right: 0, height: '100vh' }}>
        ...
        <Stack bg="white" align="center" mr={24} style={{ height: '75%', overflowY: 'auto' }}>
          ...
          <HistorySm title="First Post" date="Jul 16, 2022" description="This is the first post" />
